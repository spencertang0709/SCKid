...
@section('content')
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Tumblr Accounts</h1>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        ...
                        <p>{{$me->nickname or 'Empty'}}</p>
                        <a href="{{$me->user->url or 'No profile'}}">URL</a>

                        <form action="/auth/tumblr/" method="post">
                            <button id="add kid"  data-toggle="modal" data-target="#addKid" class="btn btn-primary" style="float: right;" >Add Tumblr Account</button>
                        </form>
                    </div>
                </div>
                <!-- /.box-body -->
