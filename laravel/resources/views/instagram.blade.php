...
@section('content')
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Instagram Accounts</h1>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        ...
                        <p>{{$me->name or 'Please add an account'}}</p>
                        <img src="{{$me->avatar or ''}}">

                        <form action="/auth/instagram/" method="get">
                            <button id="add kid"  data-toggle="modal" data-target="#addKid" class="btn btn-primary" style="float: right;" >Add Instagram Account</button>
                        </form>
